...
Examples:
  ${env.NODE_ENV === "development" ? `http://localhost:${env.PORT}` : "https://cors.mani-coder.dev"}/https://api.example.com/data
  ${env.NODE_ENV === "development" ? `http://localhost:${env.PORT}` : "https://cors.mani-coder.dev"}/http://example.com
...
/**
 * Main request handler for the CORS proxy
 * Works with both Node.js HTTP server and Vercel serverless functions
 */
